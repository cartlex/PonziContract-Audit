/*
    NFT
    Нужно разобраться, как запустить slither на данном контракте, и провалидировать вхождения всех уровней критичности, кроме informational. Все те, которые подтвердите, выписать.
